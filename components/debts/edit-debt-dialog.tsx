...
const debtSchema = z.object({
  ...
  status: z.enum(["active", "paid_off", "defaulted", "paused"]),
  notes: z.string().optional(),
});

type DebtFormData = z.infer<typeof debtSchema>;

// Reusable form component for editing debts
function EditDebtForm({
  ...
  updateDebtMutation: ReturnType<typeof useUpdateDebt>;
...
export function EditDebtDialog({
  ...
  useEffect(() => {
    if (debt) {
      form.reset({
        ledgerId: debt.ledger_id || "",
        name: debt.name,
        creditorName: debt.creditor_name || "",
        principalAmount: debt.principal_amount.toString(),
        interestRate: debt.interest_rate.toString(),
        interestType: debt.interest_type,
        compoundingFrequency: debt.compounding_frequency || undefined,
        currency: debt.currency as "INR" | "USD" | "EUR" | "GBP",
        startDate: parseDateFromDatabase(debt.start_date),
        maturityDate: debt.maturity_date
          ? parseDateFromDatabase(debt.maturity_date)
          : undefined,
        ...
        nextPaymentDate: debt.next_payment_date
          ...
          : undefined,
        payoffStrategy: debt.payoff_strategy,
        status: debt.status,
        notes: debt.notes || "",
      });
    }
      ...
      <Dialog open={open} onOpenChange={onOpenChange}>
        ...
        >
          <DialogHeader>
            ...
            <DialogDescription>
              Update your debt details and payment information.
            </DialogDescription>
          </DialogHeader>
          <EditDebtForm
            form={form}
            onSubmit={onSubmit}
            updateDebtMutation={updateDebtMutation}
    ...
    <Drawer open={open} onOpenChange={onOpenChange} repositionInputs={false}>
      <DrawerContent className="max-h-[90vh]">
        <DrawerHeader className="text-left">
          <DrawerTitle>Edit Debt</DrawerTitle>
          <DrawerDescription>
            Update your debt details and payment information.
          </DrawerDescription>
        </DrawerHeader>
