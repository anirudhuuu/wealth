...
import { generateSandboxTransactions, calculateSandboxKPIs } from "@/lib/sandbox"
...
export default async function DashboardPage() {
  ...
  if (isAdmin) {
    ...
    totalAssets = (assetData || []).reduce((sum, a) => sum + Number(a.current_value), 0)
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Charts */}
      <DashboardCharts transactions={transactions} categoryData={categoryData} />
    </div>
  )
}
