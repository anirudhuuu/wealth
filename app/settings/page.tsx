      ...
      {isAdmin && (
        <Card className="border-primary bg-primary/5">
          <CardHeader>
            ...
            <CardDescription>You have full access to all features and data management</CardDescription>
          </CardHeader>
        </Card>
      )}
        ...
        <CardContent className="space-y-4">
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div>
              ...
              <div className="mt-1">{isAdmin ? "Admin" : "Standard User (Sandbox Mode)"}</div>
            </div>
          </div>
        </CardContent>
      </Card>
